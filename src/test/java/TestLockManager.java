...
public class TestLockManager {
    ...
    //STUDENT DEVELOPED TESTS BELOW

    @Test
    public void testMatrix() {
        lockMan = new LockManager();
        assertTrue(lockMan.lockComparabilityMatrix(LockManager.LockType.IS, LockManager.LockType.IS));
        assertTrue(lockMan.lockComparabilityMatrix(LockManager.LockType.IS, LockManager.LockType.S));
        assertTrue(lockMan.lockComparabilityMatrix(LockManager.LockType.IS, LockManager.LockType.IX));
        assertFalse(lockMan.lockComparabilityMatrix(LockManager.LockType.IS, LockManager.LockType.X));

        assertTrue(lockMan.lockComparabilityMatrix(LockManager.LockType.S, LockManager.LockType.IS));
        assertTrue(lockMan.lockComparabilityMatrix(LockManager.LockType.S, LockManager.LockType.S));
        assertFalse(lockMan.lockComparabilityMatrix(LockManager.LockType.S, LockManager.LockType.IX));
        assertFalse(lockMan.lockComparabilityMatrix(LockManager.LockType.S, LockManager.LockType.X));

        assertTrue(lockMan.lockComparabilityMatrix(LockManager.LockType.IX, LockManager.LockType.IS));
        assertFalse(lockMan.lockComparabilityMatrix(LockManager.LockType.IX, LockManager.LockType.S));
        assertTrue(lockMan.lockComparabilityMatrix(LockManager.LockType.IX, LockManager.LockType.IX));
        assertFalse(lockMan.lockComparabilityMatrix(LockManager.LockType.IX, LockManager.LockType.X));

        assertFalse(lockMan.lockComparabilityMatrix(LockManager.LockType.X, LockManager.LockType.IS));
        assertFalse(lockMan.lockComparabilityMatrix(LockManager.LockType.X, LockManager.LockType.S));
        assertFalse(lockMan.lockComparabilityMatrix(LockManager.LockType.X, LockManager.LockType.IX));
        assertFalse(lockMan.lockComparabilityMatrix(LockManager.LockType.X, LockManager.LockType.X));
    }
}